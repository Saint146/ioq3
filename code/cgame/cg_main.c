...
//		}
	...
	cgs.media.dryFireSound = trap_S_RegisterSound("sound/saint/dryfire.wav", qfalse);
	cgs.media.crateredSound = trap_S_RegisterSound("sound/saint/cratered.wav", qfalse);
}
